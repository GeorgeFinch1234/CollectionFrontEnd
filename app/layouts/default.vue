  ...
  <Transition name="menuSlide">
    <div v-if="show"
      ...
      <NuxtLink @click="handleMenu" to="/collection"
        class="text-[25px] hover:bg-alt w-[300px] self-center rounded-md duration-[1.5s] bg-secondary text-center sm:bg-alt sm:text-[20px] sm:w-[100px] sm:hover:bg-secondary z-10 sm:z-[10] border-2 border-solid border-primary">
        collection</NuxtLink>
